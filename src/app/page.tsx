          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <div className="flex-shrink-0">
                <h1 className="text-2xl font-bold text-gray-900">BOX</h1>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              <Link
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
              Your files, <span className="text-blue-600">simplified</span>
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">Your files are encrypted and stored securely in the cloud with enterprise-grade security.</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">Drag and drop files or browse to upload. Support for all major file types up to 2MB.</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">Share files with anyone, anywhere. Control permissions and track access in real-time.</p>
            </div>
          </div>
        </div>
      </section>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 border-2 border-transparent">
              ...
              <ul className="space-y-4 mb-8">
                ...
                <li className="flex items-center">
                  ...
                  <span className="text-gray-600">Basic file sharing</span>
                </li>
                <li className="flex items-center">
                  <svg className="w-5 h-5 text-green-500 mr-3" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  <span className="text-gray-600">2MB file limit</span>
                </li>
                <li className="flex items-center">
                  <svg className="w-5 h-5 text-green-500 mr-3" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 border-2 border-transparent">
              ...
              <ul className="space-y-4 mb-8">
                ...
                <li className="flex items-center">
                  ...
                  <span className="text-gray-600">1GB file limit</span>
                </li>
                <li className="flex items-center">
                  <svg className="w-5 h-5 text-green-500 mr-3" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-2xl font-bold mb-4">BOX</h3>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2025 BOX. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
